...
const ContactForm = () => {
    ...
    return (
        <section className="relative z-10 py-16">
            <div className="container mx-auto px-4 max-w-4xl"> {/* Ensuring width matches the news section */}
                <h1 className="text-5xl font-bold mb-8 text-white text-center tracking-wide">
                    Contact Us
                </h1>
                <form onSubmit={handleSubmit} className="space-y-6 bg-opacity-20 bg-blue-900 p-8 rounded-lg shadow-2xl border border-blue-500 max-w-4xl mx-auto">
                    {/* Added max-w-4xl and mx-auto for more control */}
                    <div>
